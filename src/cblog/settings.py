...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.czylf6vsxixb.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'doganaws' # please enter your s3 bucket name
